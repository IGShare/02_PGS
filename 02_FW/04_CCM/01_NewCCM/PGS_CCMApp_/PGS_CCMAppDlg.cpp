...
BOOL CPGS_CCMAppDlg::OnInitDialog()
{
	...
	glPDlgShowWarnMsg->Create (IDD_PGS_CCMAPP_WARN_MSG, this);
	...
	m_pDlgSG = new CDlgCCMAppExit;
	m_pDlgSG->Create (IDD_PGS_CCMAPP_EXIT, this);
...
int CPGS_CCMAppDlg::AutoInitSCM (int idxSCM)
{
	...
	SendSBoardMessage (1, idxSCM+MIN_DEV_ID_SCM + 0x10);
	return 1;
}
...
void CPGS_CCMAppDlg::SendEBoardMessage ()
{
//	return;//////////////////////////////////////////////////
...
//	return;//////////////////////////////////////////////////
	...
	// Status BD[S]
	if (m_commEbd.ConnectComm (2, 9600, 8, 'N', 1) != 0)
	{
		AfxMessageBox (_T("포트 열기 실패 : 3"));
		return;
	}
