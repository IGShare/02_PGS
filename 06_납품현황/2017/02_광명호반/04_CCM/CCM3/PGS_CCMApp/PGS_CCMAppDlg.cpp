...
//	return;//////////////////////////////////////////////////
	...
	nEBD1_Green1_L		=	bufNGrGrp[ 5]+bufNGrGrp[ 6];				
	
	nEBD1_Green2_L		=	bufNGrGrp[ 5]+bufNGrGrp[ 6];
	nEBD1_Green2_R		=	bufNGrGrp[ 5]+bufNGrGrp[ 6];			
	nEBD1_Green3_L		=	bufNGrGrp[ 5]+bufNGrGrp[ 6];				
	nEBD1_Green3_R		=	bufNGrGrp[ 5]+bufNGrGrp[ 6];		
	nEBD1_Green4_L		=	bufNGrGrp[ 5];				
	nEBD1_Green4_R		=	bufNGrGrp[ 6];	
	nEBD1_Green5_L		=	bufNGrGrp[ 6];				
	nEBD1_Green5_R		=	bufNGrGrp[ 5];		
	...
	if( (nEBD1_Green2_L != m_nOld_EBD1_Green2_L) ){
			sprintf_s (strTmp, MAX_PATH, "_u_u_u_u B3F%4d", nEBD1_Green2_L);
			SendTxtToEBoard (glIGlobal.EBD1Comm_bufDstID[IDX_EBD1_STAIR_ID_02], strTmp, bufClrGreen, &m_commEbd1);
			Sleep (glIGlobal.EBD1Comm_timeSendInterval);
		
	}
	if((nEBD1_Green3_L != m_nOld_EBD1_Green3_L) ){
			sprintf_s (strTmp, MAX_PATH, "_u_u_u_u B3F%4d",nEBD1_Green3_L);
