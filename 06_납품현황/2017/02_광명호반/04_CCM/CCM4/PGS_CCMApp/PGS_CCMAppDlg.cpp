	...
	: CDialog(CPGS_CCMAppDlg::IDD, pParent)
{
	...
	m_nOld_EBD1_Green1_1=-1;
	m_nOld_EBD1_Green1_2=-1;
	m_nOld_EBD1_Green1_3=-1;
...
//	return;//////////////////////////////////////////////////
	...
	int nEBD1_Green1_1, nEBD1_Green1_2, nEBD1_Green1_3;
	...
	//입구만차 1번
	if((nEBD1_Green1_1 != m_nOld_EBD1_Green1_1) || (nEBD1_Green1_2 != m_nOld_EBD1_Green1_2) ||(nEBD1_Green1_3 != m_nOld_EBD1_Green1_3)){
			sprintf_s (strTmp, MAX_PATH, "%4d%4d%4d",nEBD1_Green1_3, nEBD1_Green1_2, nEBD1_Green1_1);
	...
	if((nEBD1_Green4_L != m_nOld_EBD1_Green4_L) || (nEBD1_Green4_R != m_nOld_EBD1_Green4_R) ){
			sprintf_s (strTmp, MAX_PATH, "_u_u_l_l%4dXXXX", nEBD1_Green4_R, nEBD1_Green4_L);
			SendTxtToEBoard (glIGlobal.EBD1Comm_bufDstID[IDX_EBD1_STAIR_ID_04], strTmp, bufClrGreen, &m_commEbd1);
			Sleep (glIGlobal.EBD1Comm_timeSendInterval);
	}
	if((nEBD1_Green5_L != m_nOld_EBD1_Green5_L) || (nEBD1_Green3_R != m_nOld_EBD1_Green5_R) ){
			sprintf_s (strTmp, MAX_PATH, "_u_u_u_u%4dXXXX",nEBD1_Green5_L);
	...
	if((nEBD1_Green6_L != m_nOld_EBD1_Green6_L) || (nEBD1_Green6_R != m_nOld_EBD1_Green6_R) ){
			...
			SendTxtToEBoard (glIGlobal.EBD1Comm_bufDstID[IDX_EBD1_STAIR_ID_06], strTmp, bufClrGreen, &m_commEbd1);
			Sleep (glIGlobal.EBD1Comm_timeSendInterval);
	}


	m_nOld_EBD1_Green1_1   = nEBD1_Green1_1;
	m_nOld_EBD1_Green1_2   = nEBD1_Green1_2;
	m_nOld_EBD1_Green1_3   = nEBD1_Green1_3;
