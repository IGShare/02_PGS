...
//	return;//////////////////////////////////////////////////
	...
	nEBD1_Green1_L		=	bufNGrGrp[ 3]+bufNGrGrp[ 4];				
	nEBD1_Green2_L		=	bufNGrGrp[ 3]+bufNGrGrp[ 4];				
		
	nEBD1_Green3_L		=	bufNGrGrp[ 3]+bufNGrGrp[ 4];			
	nEBD1_Green3_R		=	bufNGrGrp[ 3]+bufNGrGrp[ 4];

	nEBD1_Green4_L		=	bufNGrGrp[ 3]+bufNGrGrp[ 4];			
	nEBD1_Green4_R		=	bufNGrGrp[ 3]+bufNGrGrp[ 4];

	nEBD1_Green5_L		=	bufNGrGrp[ 4];			
	nEBD1_Green5_R		=	bufNGrGrp[ 3];	
	...
	if((nEBD1_Green1_L != m_nOld_EBD1_Green1_L) ){
			sprintf_s (strTmp, MAX_PATH, "%4d", nEBD1_Green1_L);
			SendTxtToEBoard (glIGlobal.EBD1Comm_bufDstID[IDX_EBD1_ENTRANCE_01], strTmp, bufClrGreen, &m_commEbd1);
			Sleep (glIGlobal.EBD1Comm_timeSendInterval);
		
	}

	if((nEBD1_Green2_L != m_nOld_EBD1_Green2_L) ){
			sprintf_s (strTmp, MAX_PATH, "%4d", nEBD1_Green2_L);
			SendTxtToEBoard (glIGlobal.EBD1Comm_bufDstID[IDX_EBD1_ENTRANCE_02], strTmp, bufClrGreen, &m_commEbd1);
			Sleep (glIGlobal.EBD1Comm_timeSendInterval);
		
	}

	if((nEBD1_Green3_L != m_nOld_EBD1_Green3_L) || (nEBD1_Green3_R != m_nOld_EBD1_Green3_R) ){
			sprintf_s (strTmp, MAX_PATH, "_u_u_u_u B2F%4d", nEBD1_Green3_R, nEBD1_Green3_L);
			SendTxtToEBoard (glIGlobal.EBD1Comm_bufDstID[IDX_EBD1_STAIR_ID_03], strTmp, bufClrGreen, &m_commEbd1);
			Sleep (glIGlobal.EBD1Comm_timeSendInterval);
	}

	if((nEBD1_Green4_L != m_nOld_EBD1_Green4_L) || (nEBD1_Green4_R != m_nOld_EBD1_Green4_R) ){
			sprintf_s (strTmp, MAX_PATH, "_u_u_u_u B2F%4d", nEBD1_Green4_R, nEBD1_Green4_L);
			SendTxtToEBoard (glIGlobal.EBD1Comm_bufDstID[IDX_EBD1_STAIR_ID_04], strTmp, bufClrGreen, &m_commEbd1);
			Sleep (glIGlobal.EBD1Comm_timeSendInterval);
	}

	if((nEBD1_Green5_L != m_nOld_EBD1_Green5_L) || (nEBD1_Green5_R != m_nOld_EBD1_Green5_R) ){
			sprintf_s (strTmp, MAX_PATH, "_u_u_l_l%4d%4d", nEBD1_Green5_R, nEBD1_Green5_L);
			SendTxtToEBoard (glIGlobal.EBD1Comm_bufDstID[IDX_EBD1_STAIR_ID_05], strTmp, bufClrGreen, &m_commEbd1);
			Sleep (glIGlobal.EBD1Comm_timeSendInterval);
	}
...
//	return;//////////////////////////////////////////////////
	...
	nGreen1_SBD_L		=	bufNGrGrp[ 3]+bufNGrGrp[ 4];				
	nGreen2_SBD_L		=	bufNGrGrp[ 3]+bufNGrGrp[ 4];			
			
	nGreen3_SBD_L		=	bufNGrGrp[ 3]+bufNGrGrp[ 4];				
	nGreen3_SBD_R		=	bufNGrGrp[ 3]+bufNGrGrp[ 4];			

	nGreen4_SBD_L		=	bufNGrGrp[ 3]+bufNGrGrp[ 4];				
	nGreen4_SBD_R		=	bufNGrGrp[ 3]+bufNGrGrp[ 4];	

	nGreen5_SBD_L		=	bufNGrGrp[ 4];				
	nGreen5_SBD_R		=	bufNGrGrp[ 3];	
