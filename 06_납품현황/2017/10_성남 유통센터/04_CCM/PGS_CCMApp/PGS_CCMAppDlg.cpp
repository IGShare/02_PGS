...
//	return;//////////////////////////////////////////////////
	...
	nEBD1_Green1_L		=	bufNGrGrp[ 1]+bufNGrGrp[ 2]+bufNGrGrp[ 5]+bufNGrGrp[ 7]+bufNGrGrp[ 9]+bufNGrGrp[ 11]+bufNGrGrp[ 12]+bufNGrGrp[ 13];				
	nEBD1_Green1_R		=	bufNGrGrp[ 3]+bufNGrGrp[ 4]+bufNGrGrp[ 6]+bufNGrGrp[ 8]+bufNGrGrp[ 10];				
	nEBD1_Green2_L		=	bufNGrGrp[ 2];				
	nEBD1_Green2_R		=	bufNGrGrp[ 4]+bufNGrGrp[ 5]+bufNGrGrp[ 6]+bufNGrGrp[ 7]+bufNGrGrp[ 8]+bufNGrGrp[ 9]+bufNGrGrp[ 10]+bufNGrGrp[ 11]+bufNGrGrp[ 12]+bufNGrGrp[ 13];				
	nEBD1_Green3_L		=	bufNGrGrp[ 5]+bufNGrGrp[ 12]+bufNGrGrp[ 13];				
	nEBD1_Green3_R		=	bufNGrGrp[ 6]+bufNGrGrp[ 7]+bufNGrGrp[ 8]+bufNGrGrp[ 9]+bufNGrGrp[ 10]+bufNGrGrp[ 11];				


	nEBD1_Green4_L		=	bufNGrGrp[ 7]+bufNGrGrp[12]+bufNGrGrp[13];
	nEBD1_Green4_R		=	bufNGrGrp[ 8]+bufNGrGrp[ 9]+bufNGrGrp[ 10]+bufNGrGrp[ 11]+bufNGrGrp[12]+bufNGrGrp[13];				
	nEBD1_Green5_L		=	bufNGrGrp[ 9]+bufNGrGrp[12]+bufNGrGrp[13];				
	nEBD1_Green5_R		=	bufNGrGrp[10]+bufNGrGrp[11]+bufNGrGrp[12]+bufNGrGrp[13];
	nEBD1_Green6_L		=	bufNGrGrp[11]+bufNGrGrp[12]+bufNGrGrp[ 13];				
	nEBD1_Green6_R		=	bufNGrGrp[10];		



	n_EBD1_Entrance_7 = bufNGrGrp[ 1]+bufNGrGrp[ 2]+bufNGrGrp[ 3]+bufNGrGrp[ 4]+bufNGrGrp[ 5]+bufNGrGrp[ 6]+bufNGrGrp[ 7]+bufNGrGrp[ 8]+bufNGrGrp[ 9]+bufNGrGrp[ 10]+bufNGrGrp[ 11]+bufNGrGrp[ 12]+bufNGrGrp[ 13];	
	//전광판 setting
	// 0xe0 0x18	: _u	: 위쪽 화살표
	...
	if((nEBD1_Green3_L != m_nOld_EBD1_Green3_L) || (nEBD1_Green3_R != m_nOld_EBD1_Green3_R) ){
			sprintf_s (strTmp, MAX_PATH, "_u_u_l_l%4d%4d", nEBD1_Green3_L, nEBD1_Green3_R);
	...
	if((nEBD1_Green4_L != m_nOld_EBD1_Green4_L) || (nEBD1_Green4_R != m_nOld_EBD1_Green4_R) ){
			sprintf_s (strTmp, MAX_PATH, "_u_u_l_l%4d%4d", nEBD1_Green4_L, nEBD1_Green4_R);
	...
	if((nEBD1_Green5_L != m_nOld_EBD1_Green5_L) || (nEBD1_Green5_R != m_nOld_EBD1_Green5_R) ){
			sprintf_s (strTmp, MAX_PATH, "_u_u_l_l%4d%4d", nEBD1_Green5_L, nEBD1_Green5_R);
	...
	if((nEBD1_Green6_L != m_nOld_EBD1_Green6_L) || (nEBD1_Green6_R != m_nOld_EBD1_Green6_R) ){
			sprintf_s (strTmp, MAX_PATH, "_r_r_r_r%4d출구", nEBD1_Green6_R);
	...
	//if((nEBD1_Green6_L != m_nOld_EBD1_Green6_L) || (nEBD1_Green6_R != m_nOld_EBD1_Green6_R) )
	{
		if(n_EBD1_Entrance_7 >19)
		{
			sprintf_s (strTmp, MAX_PATH, "%4d", n_EBD1_Entrance_7);
		...
		{
			sprintf_s (strTmp, MAX_PATH, "%4d", n_EBD1_Entrance_7);
			SendTxtToEBoard (glIGlobal.EBD1Comm_bufDstID[IDX_EBD1_STAIR_ID7], strTmp, bufClrRed, &m_commEbd1);
			Sleep (glIGlobal.EBD1Comm_timeSendInterval);
		}
