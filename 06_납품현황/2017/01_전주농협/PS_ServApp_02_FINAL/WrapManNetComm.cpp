...
void CWrapManNetComm::OpenExternalServer ()
{
	m_extManNetComm = new CExternalNetComm;
	if (m_extManNetComm->InitExternalNetCommManager () == FALSE)
	{
		AfxMessageBox(_T("External Server Open Fail"));
	}
}
