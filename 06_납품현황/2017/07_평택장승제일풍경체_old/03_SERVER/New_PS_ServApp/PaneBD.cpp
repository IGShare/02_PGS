...
void CPaneBD::UpdateMainList (BOOL bFullUpdate)
{
...

	{
		...
		////stPaAll.nTotal	+=stPa1F.nTotal;
		////stPaAll.nParked	+=stPa1F.nParked;
		////stPaAll.nFree	+=stPa1F.nFree;
		...
		////stPaAll.nTotal	+=stPa2F.nTotal;
		////stPaAll.nParked	+=stPa2F.nParked;
		////stPaAll.nFree	+=stPa2F.nFree;
		...
		////stPaAll.nTotal	+=stPa3F.nTotal;
		////stPaAll.nParked	+=stPa3F.nParked;
		////stPaAll.nFree	+=stPa3F.nFree;
		...
		//m_pLicMain->SetItem (1, IDX_ML_COL_BD_NUM_AVAILABLE, LVIF_TEXT, LPCTSTR(strTmp), 0, 0, 0, 0);
		////stPaAll.nTotal	+=stPa4F.nTotal;
		////stPaAll.nParked	+=stPa4F.nParked;
		////stPaAll.nFree	+=stPa4F.nFree;
