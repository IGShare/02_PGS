...
int ResetTimeForLTPM(INFO_DISP_ITEM *pIDI);
int GetTimeIndexForLTPM(INFO_DISP_ITEM *pIDI);
...
void GetCurStatFromBDI (INFO_BACK_DRAWING_ITEM *pIBDI, STAT_PARKING_AREA &stPaAll,STAT_PARKING_AREA &stPaB1F, STAT_PARKING_AREA &stPaB2F, STAT_PARKING_AREA &stPa1F, STAT_PARKING_AREA &stPa2F, STAT_PARKING_AREA &stPa3F, STAT_PARKING_AREA &stPa4F);
