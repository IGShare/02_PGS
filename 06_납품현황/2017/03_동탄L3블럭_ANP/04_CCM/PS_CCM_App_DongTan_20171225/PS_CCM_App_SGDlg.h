...
class CPS_CCM_App_SGDlg : public CDialog
{
// 생성입니다.
public:
	CPS_CCM_App_SGDlg(CWnd* pParent = NULL);	// 표준 생성자입니다.

// 대화 상자 데이터입니다.
	enum { IDD = IDD_PS_CCM_APP_SG_DIALOG };

	CDlgSettingGeneral *m_pDlgSG;
	...
	int m_nOldGreen1_SBD_L;
	int m_nOldGreen1_SBD_R;
	int m_nOldGreen2_SBD_L;
	int m_nOldGreen2_SBD_R;
	int m_nOldGreen3_SBD_L;
	int m_nOldGreen3_SBD_R;
	int m_nOldGreen4_SBD_L;
	int m_nOldGreen4_SBD_R;
	int m_nOldGreen5_SBD_L;
	int m_nOldGreen5_SBD_R;
	int m_nOldGreen6_SBD_L;
	int m_nOldGreen6_SBD_R;
	int m_nOldGreen7_SBD_L;
	int m_nOldGreen7_SBD_R;
	int m_nOldGreen8_SBD_L;
...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	afx_msg LPARAM OnDooNotifyUpdateDlgSG (WPARAM wParam, LPARAM lParam);
