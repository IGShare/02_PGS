	...
	: CDialog(CPS_CCM_App_SGDlg::IDD, pParent)
{
	...
	m_nOldGreen1_SBD_L = -1;
	m_nOldGreen1_SBD_R = -1;
	m_nOldGreen2_SBD_L = -1;
	m_nOldGreen2_SBD_R = -1;
	m_nOldGreen3_SBD_L = -1;
	m_nOldGreen3_SBD_R = -1;
	m_nOldGreen4_SBD_L = -1;
	m_nOldGreen4_SBD_R = -1;
	m_nOldGreen5_SBD_L = -1;
	m_nOldGreen5_SBD_R = -1;
	m_nOldGreen6_SBD_L = -1;
	m_nOldGreen6_SBD_R = -1;
	m_nOldGreen7_SBD_L = -1;
	m_nOldGreen7_SBD_R = -1;
	m_nOldGreen8_SBD_L = -1;
...
void CPS_CCM_App_SGDlg::SendEBoardMessage ()
{
	...
	int nGreen1_EBD_B1,nGreen1_EBD_B2;
	int nGreen2_SBD_L,nGreen2_SBD_R;
	int nGreen3_SBD_L,nGreen3_SBD_R;
	int nGreen4_SBD_L,nGreen4_SBD_R;
	int nGreen5_SBD_L,nGreen5_SBD_R;
	int nGreen6_SBD_L,nGreen6_SBD_R;
	int nGreen7_SBD_L,nGreen7_SBD_R;
	int nGreen8_SBD_L,nGreen8_SBD_R;
	int nGreen9_SBD_L,nGreen9_SBD_R;
	int nGreen10_SBD_L, nGreen10_SBD_R;
...
/*	if (nGreen1_1EBD != m_nOldGreen1_1EBD
	...
	{
		sprintf_s (strTmp, MAX_PATH, "_u_u_l_l%4d%4d",nGreen9_SBD_R, nGreen9_SBD_L);
		
		SendTxtToEBoard (glIGlobal.EBD1Comm_bufDstID[IDX_EBD1_STAIR_B2F_09], strTmp, bufClrGreen, &m_commEbd);
		Sleep (glIGlobal.EBD2Comm_timeSendInterval);
	}
	//B2F - ID 9
...
*/
	...
	m_nOldGreen1_SBD_L = nGreen1_EBD_B1;
	m_nOldGreen1_SBD_R = nGreen1_EBD_B2;
	m_nOldGreen2_SBD_L = nGreen2_SBD_L;
	m_nOldGreen2_SBD_R = nGreen2_SBD_L;
	m_nOldGreen3_SBD_L = nGreen3_SBD_L;
	m_nOldGreen3_SBD_R = nGreen3_SBD_R;
	m_nOldGreen4_SBD_L = nGreen4_SBD_L;
	m_nOldGreen4_SBD_R = nGreen4_SBD_R;
	m_nOldGreen5_SBD_L = nGreen5_SBD_L;
	m_nOldGreen5_SBD_R = nGreen5_SBD_R;
	m_nOldGreen6_SBD_L = nGreen6_SBD_L;
	m_nOldGreen6_SBD_R = nGreen6_SBD_R;
	m_nOldGreen7_SBD_L = nGreen7_SBD_L;
	m_nOldGreen7_SBD_R = nGreen7_SBD_R;
	m_nOldGreen8_SBD_L = nGreen8_SBD_L;
	m_nOldGreen8_SBD_R = nGreen8_SBD_R;
	m_nOldGreen9_SBD_L = nGreen9_SBD_L;
	m_nOldGreen9_SBD_R = nGreen9_SBD_R;
