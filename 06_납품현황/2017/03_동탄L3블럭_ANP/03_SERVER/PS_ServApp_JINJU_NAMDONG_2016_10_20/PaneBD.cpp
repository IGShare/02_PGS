...
{
	//return;/////////////////////////////////////////////////////////
	STAT_PARKING_AREA stPaAll, stPa1_B1F, stPa1_B2F,stPa2_1F;
	INFO_BACK_DRAWING_ALL *pIBDA = &glInfoGlobal.iBDA;
	INFO_BACK_DRAWING_ITEM *pIBDI;
	CString strTmp;

	pIBDI = &pIBDA->bufBDI[pIBDA->bufIdxMainBDI[0]];
	GetCurStatFromBDI (pIBDI, stPaAll, stPa1_B1F, stPa1_B2F,stPa2_1F);
