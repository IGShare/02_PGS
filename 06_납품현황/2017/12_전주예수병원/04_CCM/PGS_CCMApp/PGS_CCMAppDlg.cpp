...
//	return;//////////////////////////////////////////////////
	...
	nEBD1_Green1_L		=	bufNGrGrp[ 2]; //지상2층 일부				
	nEBD1_Green1_R		=	bufNGrGrp[ 4]; //지상3층 전체				
	nEBD1_Green2_L		=	bufNGrGrp[ 1]; // 1F			
	nEBD1_Green2_R		=	bufNGrGrp[ 1]; // 지상1층전체				
	...
	nEBD1_Green6_R		=	glIGlobal.EBDComm_numFreeCMS; // 옥상층 (중앙감시반)	
