...
public:
	...
	afx_msg void OnParkingStatusDescription();
	afx_msg void OnParkingStatusDescription1();
	afx_msg LRESULT OnBDEW_MouseLBtnClickPaneInfo(WPARAM wParam, LPARAM lParam);
};
