...
BEGIN_MESSAGE_MAP(CPS_ServAppView, CView)
	ON_MESSAGE (WM_BDEW_MSG_MOUSE_CLICK_PANEINFO, OnBDEW_MouseLBtnClickPaneInfo)
	ON_WM_SIZE()
	ON_WM_CREATE()
	ON_WM_SETFOCUS()
	ON_WM_DESTROY()
...
LRESULT CPS_ServAppView::OnBDEW_MouseLBtnClickPaneInfo(WPARAM wParam, LPARAM lParam)
{

	CMainFrame *pFrame = (CMainFrame *)AfxGetMainWnd();
	pFrame->m_paneInfoEbd.UpdateMainList(1);
	//AfxMessageBox(_T("HI"));
	return 0;
