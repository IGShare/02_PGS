================================================================================
    MFC 라이브러리 : PS_ServApp 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 PS_ServApp 응용 프로그램을 
만들었습니다.  이 응용 프로그램은 MFC(Microsoft Foundation Classes)의
기본적인 사용법을 보여 주며 응용 프로그램 작성을 위한 출발점을 제공합니다.

이 파일에는 PS_ServApp 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
PS_ServApp.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CPS_ServAppApp 응용 프로그램
    클래스를 선언합니다.

PS_ServApp.cpp
    응용 프로그램 클래스 CPS_ServAppApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\PS_ServApp.ico
    ...
    주 리소스 파일인 PS_ServApp.rc에 의해 포함됩니다.
...
res\Toolbar.bmp
    ...
    PS_ServApp.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음
    단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////
...
PS_ServAppDoc.h, PS_ServAppDoc.cpp - 문서
    이 파일에는 CPS_ServAppDoc 클래스가 들어 있습니다.  이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CPS_ServAppDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

PS_ServAppView.h, PS_ServAppView.cpp - 문서 뷰
    이 파일에는 CPS_ServAppView 클래스가 들어 있습니다.
    CPS_ServAppView 개체는 CPS_ServAppDoc 개체를 보는 데 사용됩니다.

res\PS_ServAppDoc.ico
    CPS_ServAppDoc 클래스의 MDI 자식 창에 대한 아이콘으로 사용되는
    아이콘 파일입니다.  이 아이콘은 주 리소스 파일인 PS_ServApp.rc에
    의해 포함됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 PS_ServApp.pch와
